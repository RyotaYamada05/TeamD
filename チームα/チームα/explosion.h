...
// マクロ定義
//=============================================================================
#define EXPLOSION_SIZE_X			(7)			// 爆発のサイズ
#define EXPLOSION_SIZE_Y			(9)			// 爆発のサイズ
#define EXPLOSION_SIZE_Z			(7)			// 爆発のサイズ
#define MAX_EXPLOSION_TEXTURE		(1)			// テクスチャの数
