...
//=============================================================================
//ライフ
#define UI_LIFE_SIZE_X			(405)		//ライフUIのXサイズ
...
#define UI_HIT_POS_RIGHT_X		(320.0f)	// ヒットUIの左側のXサイズ
#define UI_HIT_POS_LEFT_X		(960.0f)	// ヒットUIの右側のXサイズ
#define UI_HIT_POS_Y			(600.0f)	// ヒットUIの左側のYサイズ
//種類
